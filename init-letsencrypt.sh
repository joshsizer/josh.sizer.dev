...
domains=(josh.sizer.dev)
rsa_key_size=4096
data_path="./certbot/etc/letsencrypt"
email="joshsizer@gmail.com" # Adding a valid address is strongly recommended
...
echo "### Starting nginx ..."
docker-compose up --force-recreate -d mynginx
echo
